...
class NavbarComponent extends Component {
          ...
          <ul className="nav navbar-nav navbar-right">
            ...
            <li className="dropdown">
              ...
              <ul className="dropdown-menu animated fadeInUp" role="menu">
                ...
                <li>
                  <Link to="/ico/publish">Publish ICO</Link>
                </li>
  ...
  render() {
    const opacity = Math.min(
      Math.max(this.state.currentScrollHeight / 100, this.state.defaultOpacity),
      0.9
    );
    return (
      <div id="top">
        <div className="container">
          <nav
            ...
            style={{ backgroundColor: `rgba(44,44,44,${opacity})` }}
          >
